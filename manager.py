...
def managerFunctions(managerEmail):
    ...
    while True:             # While True statement used to create an infinite loop
        try:                  # try statement used so that program will not display error message
                                ...
                                while True:
                                    ...
                                    if editdish == 0:        # Will save and exit the program
                                        ...
                                        if editdish == 1:                    # Editing dish name
                                            ...
                                            newIngredients = str(input("Please enter new ingredients of the dish separated by ',': "))
                                            # Validate that current category entered is valid
                                        ...
                                        # Delete dish on menu
                                                ...
                                                delet = input("Enter 'yes' to delete or 'no' to cancel: ")     # 'delet' is variable name to continue or stop.
                                                if delet == "yes":
                                                    del info[editing]
                                                    writeMenu(info)
                                                    print()
            ...
            # Editing an existing customer's info
            elif command == 4:
                ...
                while True:
                    ...
                    while True:
                        ...
                        # Editing current email of customer
                        elif editindex == 2:
                            newEmail = input("Enter new email of customer: ")
                            if verifyEmail(newEmail):
                                while True:
                                    if newEmail.find("@") and newEmail.find(".") and newEmail.strip():     #Don't really need this cause already verify email in line 266
                                        break                                                                  #strip removes all blank spaces
                                    print()
                        ...
                        elif editindex == 4:                                      # Editing customer contact info
                        ...
                        elif editindex == 5:                                                              # Deleting customer
                            print(f"Are you sure you want to delete {info[email]["Nickname"]} profile")
                            conDelete = input("Please enter 'yes' to delete and 'no' to cancel: ")        # conDelete = variable name for confirm Delete
                            if conDelete == "yes":
                                del info[selectedEmail]
            ...
            elif command == 5:       # Modifying own profile(Manager)
...
managerFunctions("james@gmail.com")